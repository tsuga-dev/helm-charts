...
| agent.image | string | "" | OpenTelemetry Collector image for agent Falls back to the top-level image, then to the pinned opentelemetry-collector-contrib image the chart ships. |
