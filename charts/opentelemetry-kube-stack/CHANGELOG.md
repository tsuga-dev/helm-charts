...
## [opentelemetry-kube-stack-0.11.3] - 2026-07-31
...
- system.linux.memory.available, which is MemAvailable from /proc/meminfo and therefore the figure the kernel's own OOM accounting tracks. system.memory.usage{state=free} reads alarmingly low on any node with a warm page cache and is not a substitute
