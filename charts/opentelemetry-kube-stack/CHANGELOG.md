...
### Added
- Collect Kubernetes Warning events, filtered at the API server

## [opentelemetry-kube-stack-0.10.7] - 2026-07-28
...
## [opentelemetry-kube-stack-0.10.6] - 2026-07-28
...
### Added
- Optional PriorityClass for the agent, off by default

### Fixed
- Stop the cluster receiver running two replicas during a rollout

### Changed
- Document what empty agent tolerations cost in node coverage
